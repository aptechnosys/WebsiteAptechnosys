...
export default function Contact() {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      // Privacy consent is only used for form validation.
      // It does not need to be sent to the contact API.
        ...
        <div className="text-center mb-16">
          <motion.div {...reveal(0, 18, 0.5)}>
            ...
            <p className="text-zinc-600 dark:text-zinc-400 text-lg max-w-xl mx-auto">
              Tell us about your project. We&apos;ll review and respond within
              24 hours with a strategy call invitation.
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="glass rounded-2xl border border-zinc-900/[0.06] dark:border-white/[0.06] p-6">
              <h3 className="text-zinc-900 dark:text-white font-semibold mb-6">
                Get in touch
              </h3>
            ...
            {/* Response Commitment */}
            <div className="glass rounded-2xl border border-zinc-900/[0.06] dark:border-white/[0.06] p-6">
              <h4 className="text-zinc-900 dark:text-white text-sm font-semibold mb-4">
                Response commitment
              </h4>
          ...
          >
            {submitted ? (
              ...
              <div className="glass rounded-2xl border border-emerald-500/30 p-12 text-center h-full flex flex-col items-center justify-center">
                ...
                <h3 className="text-zinc-900 dark:text-white text-xl font-bold mb-2">
                  Message sent!
                </h3>

                <p className="text-zinc-600 dark:text-zinc-400 text-sm mb-6 max-w-xs">
                  We&apos;ve received your inquiry. Expect a reply within 24
                ...
                <Button
                  ...
                  variant="outline"
                  className="border-zinc-900/10 dark:border-white/10 text-zinc-600 dark:text-zinc-300 hover:text-zinc-900 dark:hover:text-white"
                >
                  Send another
                </Button>
              </div>
              ...
              <form
                ...
                className="glass rounded-2xl border border-zinc-900/[0.06] dark:border-white/[0.06] p-8 space-y-5"
              >
                {/* Name / Email */}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full bg-zinc-900/[0.03] dark:bg-white/[0.04] border rounded-lg px-4 py-3 text-sm text-zinc-900 dark:text-white placeholder-zinc-400 dark:placeholder-zinc-600 focus:outline-none focus:ring-1 focus:ring-blue-500/50 transition-all ${
                        errors.name
                          ? "border-red-500/50"
                          : "border-zinc-900/[0.08] dark:border-white/[0.08] hover:border-zinc-900/[0.15] dark:hover:border-white/[0.15]"
                      }`}
                ...
                <div>
                  ...
                  <select
                    ...
                    className={`w-full bg-white dark:bg-[#09090b] border rounded-lg px-4 py-3 text-sm text-zinc-700 dark:text-zinc-300 focus:outline-none focus:ring-1 focus:ring-blue-500/50 transition-all ${
                      errors.projectType
                        ? "border-red-500/50"
                        : "border-zinc-900/[0.08] dark:border-white/[0.08] hover:border-zinc-900/[0.15] dark:hover:border-white/[0.15]"
                    }`}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className={`w-full resize-none rounded-lg border bg-zinc-900/[0.03] dark:bg-white/[0.04] px-4 py-3 text-sm text-zinc-900 dark:text-white placeholder-zinc-400 dark:placeholder-zinc-600 transition-all focus:outline-none focus:ring-1 focus:ring-blue-500/50 ${
                      errors.message
                        ? "border-red-500/50"
                        : "border-zinc-900/[0.08] dark:border-white/[0.08] hover:border-zinc-900/[0.15] dark:hover:border-white/[0.15]"
                    }`}
                ...
                <div className="space-y-2 pt-1">
                  <label className="flex items-start gap-3 cursor-pointer">
                    <input
                      ...
                      className={`mt-1 h-4 w-4 shrink-0 rounded border-zinc-300 dark:border-zinc-700 accent-blue-600 cursor-pointer ${
                    ...
                    <span className="text-xs sm:text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed">
                      ...
                      and consent to APTechnosys using the information I
                      provide to respond to my enquiry.
                    </span>
                  </label>

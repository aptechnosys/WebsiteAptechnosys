        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 sm:gap-10 mb-12">
          <div className="sm:col-span-2 lg:col-span-2 mt-[31px]">
            <a href="#" className="flex items-center gap-2.5 mb-5 justify-center sm:justify-start">
              ...
              <span className="text-zinc-900 dark:text-white font-semibold text-lg">Aptechnosys</span>
            </a>
          ...
          {Object.entries(footerLinks).map(([category, links]) => (
            <div key={category} className="text-center sm:text-left mt-0 sm:mt-[31px]">
              <h4 className="text-zinc-900 dark:text-white text-xs font-semibold uppercase tracking-widest mb-4">{category}</h4>
              <ul className="space-y-3">
                {links.map((link) => (
                  <li key={link}>
                    <a href="#" className="text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-200 text-sm transition-colors">
                      {link}
                    </a>
                  </li>
                ))}
